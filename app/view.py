...
from app.models import (Course, Course_select_table, Course_Teacher, Dept,
...
# 学生已选课程显示
@app.route('/course_select_table', methods=[
    'GET',
])
@login_required
...
# 学生选课
@app.route('/course_teachers/<CourseNum>', methods=[
    'GET',
])
@login_required
...
# 学生退选课程
@app.route('/course_drop/<CourseNum>', methods=[
    'GET',
])
@login_required
...
# 学生选课
@app.route('/course_select/<CourseNum>/<TeacherNum>', methods=[
    'GET',
])
@login_required
...
# 学生更换选课老师
@app.route('/course_change/<CourseNum>', methods=[
    'GET',
])
@login_required
...
# 管理员设置老师开设课程
@app.route('/add_course_teacher', methods=[
    'POST',
])
@login_required
...
# 管理员手动退课
@app.route('/drop_course_select', methods=[
    'POST',
])
@login_required
...
# 管理员扩容和缩容课程
@app.route('/change_course_capacity/<CourseNum>/<TeacherNum>/<add_or_sub>',
           methods=[
               'GET',
           ])
@login_required
